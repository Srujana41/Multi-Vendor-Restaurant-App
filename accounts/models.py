...
# One is the User model and the other one is the UserManager.
# It also has two methods.

#1. for creating the regular users, and 2. for creating the super users.
# And these methods are called when you run, create super user command.

# Create your models here.
class UserManager(BaseUserManager):
    # whenever you write a function or method inside a class, use self as parameter
    def create_user(self, first_name, last_name, username, email, password=None):
        ...
        user.set_password(password) #encodes the password and converts to sha-256
...
# So by extending this AbstractBaseUser we are taking the full control of editing the whole custom user model,
