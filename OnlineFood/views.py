...
def get_or_set_curremt_location(request):
...
def home(request):
    if get_or_set_curremt_location(request) is not None:
        pnt = GEOSGeometry('POINT(%s %s)' % (get_or_set_curremt_location(request)))
